...
export class ResponseProductCategoryDto {
  @ApiProperty({ description: 'Identificador da categoria do produto.', example: 1, type: Number })
  id: number;

  @ApiProperty({ description: 'Nome da categoria do produto.', example: 'Geladeira', type: String })
  name: string;

  @ApiProperty({ description: 'Slug estável da categoria.', example: 'geladeira', type: String })
  slug: string;
  ...
  @ApiProperty({
    ...
    required: false,
    nullable: true,
    example: 'https://cdn.seudominio.com/product-categories/geladeira.png',
    type: String,
  })
  iconUrl?: string;
  ...
  @ApiProperty({
    ...
    required: false,
    nullable: true,
    example: 'product-categories/geladeira.png',
    type: String,
  })
  iconKey?: string;
