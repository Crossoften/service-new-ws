...
export class QueryProductDto {
  @ApiProperty({ description: 'Busca textual.', required: false, example: 'Fiat' })
  @IsString({ message: 'O campo search deve ser um texto.' })
  @IsOptional()
  search?: string;

  @ApiProperty({ description: 'Filtro por nome.', required: false, example: 'Fiat' })
  ...
  @ApiProperty({
    description: 'Filtro por tipo de negociação.',
    required: false,
